...
class general_dev2():
    ...
    def permute(self, degree, fraction):        
        ...
        self.dna1 = torch.divide(self.dna1, deg + 1).to(dtype=torch.int16)
        self.dna2 = torch.divide(self.dna2, deg + 1).to(dtype=torch.int16)
        self.dna3 = torch.divide(self.dna3, deg + 1).to(dtype=torch.int16)
        self.dna4 = torch.divide(self.dna4, deg + 1).to(dtype=torch.int16)
        self.dna5 = torch.divide(self.dna5, deg + 1).to(dtype=torch.int16)
        self.dna6 = torch.divide(self.dna6, deg + 1).to(dtype=torch.int16)
        self.dna7 = torch.divide(self.dna7, deg + 1).to(dtype=torch.int16)
        self.dna8 = torch.divide(self.dna8, deg + 1).to(dtype=torch.int16)
        self.dna9 = torch.divide(self.dna9, deg + 1).to(dtype=torch.int16)
        self.dna10 = torch.divide(self.dna10, deg + 1).to(dtype=torch.int16)
        self.dna11 = torch.divide(self.dna11, deg + 1).to(dtype=torch.int16)
        self.dna12 = torch.divide(self.dna12, deg + 1).to(dtype=torch.int16)
        self.dna13 = torch.divide(self.dna13, deg + 1).to(dtype=torch.int16)
        self.dna14 = torch.divide(self.dna14, deg + 1).to(dtype=torch.int16)
        self.dna15 = torch.divide(self.dna15, deg + 1).to(dtype=torch.int16)
        self.dna16 = torch.divide(self.dna16, deg + 1).to(dtype=torch.int16)
        self.dna17 = torch.divide(self.dna17, deg + 1).to(dtype=torch.int16)
        self.dna18 = torch.divide(self.dna18, deg + 1).to(dtype=torch.int16)
        self.dna19 = torch.divide(self.dna19, deg + 1).to(dtype=torch.int16)
        self.dna20 = torch.divide(self.dna20, deg + 1).to(dtype=torch.int16)
        self.dna21 = torch.divide(self.dna21, deg + 1).to(dtype=torch.int16)
        self.dna22 = torch.divide(self.dna22, deg + 1).to(dtype=torch.int16)
        self.dna23 = torch.divide(self.dna23, deg + 1).to(dtype=torch.int16)
        self.dna24 = torch.divide(self.dna24, deg + 1).to(dtype=torch.int16)
        self.dna25 = torch.divide(self.dna25, deg + 1).to(dtype=torch.int16)
        self.dna26 = torch.divide(self.dna26, deg + 1).to(dtype=torch.int16)
        self.dna27 = torch.divide(self.dna27, deg + 1).to(dtype=torch.int16)
        self.dna28 = torch.divide(self.dna28, deg + 1).to(dtype=torch.int16)
        self.dna29 = torch.divide(self.dna29, deg + 1).to(dtype=torch.int16)
        self.dna30 = torch.divide(self.dna30, deg + 1).to(dtype=torch.int16)
        self.dna31 = torch.divide(self.dna31, deg + 1).to(dtype=torch.int16)
        self.dna32 = torch.divide(self.dna32, deg + 1).to(dtype=torch.int16)
        return
