...
class general_dev2():
    ...
    def permute(self, degree, fraction):        
        ...
        torch.divide(model.dna1, fraction, out=model.dna1)
        torch.divide(model.dna2, fraction, out=model.dna2)
        torch.divide(model.dna3, fraction, out=model.dna3)
        torch.divide(model.dna4, fraction, out=model.dna4)
        torch.divide(model.dna5, fraction, out=model.dna5)
        torch.divide(model.dna6, fraction, out=model.dna6)
        torch.divide(model.dna7, fraction, out=model.dna7)
        torch.divide(model.dna8, fraction, out=model.dna8)
        torch.divide(model.dna9, fraction, out=model.dna9)
        torch.divide(model.dna10, fraction, out=model.dna10)
        torch.divide(model.dna11, fraction, out=model.dna11)
        torch.divide(model.dna12, fraction, out=model.dna12)
        torch.divide(model.dna13, fraction, out=model.dna13)
        torch.divide(model.dna14, fraction, out=model.dna14)
        torch.divide(model.dna15, fraction, out=model.dna15)
        torch.divide(model.dna16, fraction, out=model.dna16)
        torch.divide(model.dna17, fraction, out=model.dna17)
        torch.divide(model.dna18, fraction, out=model.dna18)
        torch.divide(model.dna19, fraction, out=model.dna19)
        torch.divide(model.dna20, fraction, out=model.dna20)
        torch.divide(model.dna21, fraction, out=model.dna21)
        torch.divide(model.dna22, fraction, out=model.dna22)
        torch.divide(model.dna23, fraction, out=model.dna23)
        torch.divide(model.dna24, fraction, out=model.dna24)
        torch.divide(model.dna25, fraction, out=model.dna25)
        torch.divide(model.dna26, fraction, out=model.dna26)
        torch.divide(model.dna27, fraction, out=model.dna27)
        torch.divide(model.dna28, fraction, out=model.dna28)
        torch.divide(model.dna29, fraction, out=model.dna29)
        torch.divide(model.dna30, fraction, out=model.dna30)
        torch.divide(model.dna31, fraction, out=model.dna31)
        torch.divide(model.dna32, fraction, out=model.dna32)
        ...
        torch.divide(self.dna1, deg, out=self.dna1)
        torch.divide(self.dna2, deg, out=self.dna2)
        torch.divide(self.dna3, deg, out=self.dna3)
        torch.divide(self.dna4, deg, out=self.dna4)
        torch.divide(self.dna5, deg, out=self.dna5)
        torch.divide(self.dna6, deg, out=self.dna6)
        torch.divide(self.dna7, deg, out=self.dna7)
        torch.divide(self.dna8, deg, out=self.dna8)
        torch.divide(self.dna9, deg, out=self.dna9)
        torch.divide(self.dna10, deg, out=self.dna10)
        torch.divide(self.dna11, deg, out=self.dna11)
        torch.divide(self.dna12, deg, out=self.dna12)
        torch.divide(self.dna13, deg, out=self.dna13)
        torch.divide(self.dna14, deg, out=self.dna14)
        torch.divide(self.dna15, deg, out=self.dna15)
        torch.divide(self.dna16, deg, out=self.dna16)
        torch.divide(self.dna17, deg, out=self.dna17)
        torch.divide(self.dna18, deg, out=self.dna18)
        torch.divide(self.dna19, deg, out=self.dna19)
        torch.divide(self.dna20, deg, out=self.dna20)
        torch.divide(self.dna21, deg, out=self.dna21)
        torch.divide(self.dna22, deg, out=self.dna22)
        torch.divide(self.dna23, deg, out=self.dna23)
        torch.divide(self.dna24, deg, out=self.dna24)
        torch.divide(self.dna25, deg, out=self.dna25)
        torch.divide(self.dna26, deg, out=self.dna26)
        torch.divide(self.dna27, deg, out=self.dna27)
        torch.divide(self.dna28, deg, out=self.dna28)
        torch.divide(self.dna29, deg, out=self.dna29)
        torch.divide(self.dna30, deg, out=self.dna30)
        torch.divide(self.dna31, deg, out=self.dna31)
        torch.divide(self.dna32, deg, out=self.dna32)
        self.dna1.to(dtype=torch.int16)
        self.dna2.to(dtype=torch.int16)
        self.dna3.to(dtype=torch.int16)
        self.dna4.to(dtype=torch.int16)
        self.dna5.to(dtype=torch.int16)
        self.dna6.to(dtype=torch.int16)
        self.dna7.to(dtype=torch.int16)
        self.dna8.to(dtype=torch.int16)
        self.dna9.to(dtype=torch.int16)
        self.dna10.to(dtype=torch.int16)
        self.dna11.to(dtype=torch.int16)
        self.dna12.to(dtype=torch.int16)
        self.dna13.to(dtype=torch.int16)
        self.dna14.to(dtype=torch.int16)
        self.dna15.to(dtype=torch.int16)
        self.dna16.to(dtype=torch.int16)
        self.dna17.to(dtype=torch.int16)
        self.dna18.to(dtype=torch.int16)
        self.dna19.to(dtype=torch.int16)
        self.dna20.to(dtype=torch.int16)
        self.dna21.to(dtype=torch.int16)
        self.dna22.to(dtype=torch.int16)
        self.dna23.to(dtype=torch.int16)
        self.dna24.to(dtype=torch.int16)
        self.dna25.to(dtype=torch.int16)
        self.dna26.to(dtype=torch.int16)
        self.dna27.to(dtype=torch.int16)
        self.dna28.to(dtype=torch.int16)
        self.dna29.to(dtype=torch.int16)
        self.dna30.to(dtype=torch.int16)
        self.dna31.to(dtype=torch.int16)
        self.dna32.to(dtype=torch.int16)
        return
