...
class velvet():
    ...
    def permute(self, degree, fraction):        
        ...
        torch.divide(model.layer29, fraction, self.layer29)
        torch.divide(model.layer30, fraction, self.layer30)
        torch.divide(model.layer31, fraction, self.layer31)
        torch.divide(model.layer32, fraction, self.layer32)
        torch.divide(model.layer33, fraction, self.layer33)
        torch.divide(model.layer34, fraction, self.layer34)
        torch.divide(model.layer35, fraction, self.layer35)
        torch.divide(model.layer36, fraction, self.layer36)
        torch.divide(model.layer37, fraction, self.layer37)
        torch.divide(model.layer38, fraction, self.layer38)
        torch.divide(model.layer39, fraction, self.layer39)
        torch.divide(model.layer40, fraction, self.layer40)
        torch.divide(model.layer41, fraction, self.layer41)
        torch.divide(model.layer42, fraction, self.layer42)
        torch.divide(model.layer43, fraction, self.layer43)
        torch.divide(model.layer44, fraction, self.layer44)
        torch.divide(model.layer45, fraction, self.layer45)
        torch.divide(model.layer46, fraction, self.layer46)
        torch.divide(model.layer47, fraction, self.layer47)
        torch.divide(model.layer48, fraction, self.layer48)
        torch.divide(model.layer49, fraction, self.layer49)
        torch.divide(model.layer50, fraction, self.layer50)
        torch.divide(model.layer51, fraction, self.layer51)
        torch.divide(model.layer52, fraction, self.layer52)
        torch.divide(model.layer53, fraction, self.layer53)
        torch.divide(model.layer54, fraction, self.layer54)
        torch.divide(model.layer55, fraction, self.layer55)
        torch.divide(model.layer56, fraction, self.layer56)
        torch.divide(model.layer57, fraction, self.layer57)
        torch.divide(model.layer58, fraction, self.layer58)
        torch.divide(model.layer59, fraction, self.layer59)
        torch.divide(model.layer60, fraction, self.layer60)
